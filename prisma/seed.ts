...
async function main() {
  ...
  const products = [
    ...
    { name: "Warhammer 40K: Space Marine Squad", description: "10-model kit of Primaris Intercessors. Build, paint, and conquer.", price: 52.00, category: "WARGAMING", stock: 12, featured: true },
    ...
    { name: "Age of Sigmar: Stormcast Eternals", description: "Start Collecting box for the iconic Stormcast faction.", price: 95.00, category: "WARGAMING", stock: 6 },
  ...
  const events = [
    ...
    { title: "Warhammer 40K League - Season 3", description: "6-week escalation league. 500pts to 2000pts.", date: nextDay(now, 6, 12), type: "WARHAMMER_LEAGUE", capacity: 16, price: 10 },
